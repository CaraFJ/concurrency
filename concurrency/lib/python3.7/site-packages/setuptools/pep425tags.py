...
def get_abi_tag():
    ...
    if not soabi and impl in {"cp", "pp"} and hasattr(sys, "maxunicode"):
        ...
        if get_flag("WITH_PYMALLOC", lambda: impl == "cp", warn=(impl == "cp")):
            m = "m"
        if get_flag("Py_UNICODE_SIZE", lambda: sys.maxunicode == 0x10FFFF, expected=4, warn=(impl == "cp" and six.PY2)) and six.PY2:
            u = "u"
...
def get_darwin_arches(major, minor, machine):
    ...
    groups = OrderedDict(
        [("fat", ("i386", "ppc")), ("intel", ("x86_64", "i386")), ("fat64", ("x86_64", "ppc64")), ("fat32", ("x86_64", "i386", "ppc")),]
    )
