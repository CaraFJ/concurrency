...
def _augment_exception(exc, version, arch=""):
    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        ...
        if version == 9.0:
            ...
            message += ' Get it with "Microsoft Visual C++ Build Tools": ' r"https://visualstudio.microsoft.com/downloads/"
...
class PlatformInfo:
    ...
    def target_dir(self, hidex86=False, x64=False):
        ...
        """
        return "" if (self.target_cpu == "x86" and hidex86) else r"\x64" if (self.target_cpu == "amd64" and x64) else r"\%s" % self.target_cpu
...
class SystemInfo:
    ...
    def _use_last_dir_name(self, path, prefix=""):
        ...
        """
        matching_dirs = (
            dir_name for dir_name in reversed(os.listdir(path)) if os.path.isdir(os.path.join(path, dir_name)) and dir_name.startswith(prefix)
        )
...
class EnvironmentInfo:
    ...
    def VCIncludes(self):
        ...
        """
        return [os.path.join(self.si.VCInstallDir, "Include"), os.path.join(self.si.VCInstallDir, r"ATLMFC\Include")]
    ...
    def OSLibpath(self):
        ...
        if self.vc_ver >= 14.0:
            libpath += [
                ...
                os.path.join(
                    self.si.WindowsSdkDir, "ExtensionSDKs", "Microsoft.VCLibs", "%0.1f" % self.vc_ver, "References", "CommonConfiguration", "neutral",
                ),
            ]
        return libpath
    ...
    def return_env(self, exists=True):
        ...
        env = dict(
            ...
            lib=self._build_paths("lib", [self.VCLibraries, self.OSLibraries, self.FxTools, self.UCRTLibraries, self.NetFxSDKLibraries], exists),
