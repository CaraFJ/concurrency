...
class Pep517HookCaller(object):
    ...
    def prepare_metadata_for_build_wheel(self, metadata_directory, config_settings=None):
        ...
        return self._call_hook(
            "prepare_metadata_for_build_wheel", {"metadata_directory": abspath(metadata_directory), "config_settings": config_settings,}
        )
    ...
    def build_wheel(self, wheel_directory, config_settings=None, metadata_directory=None):
        ...
        return self._call_hook(
            "build_wheel",
            {"wheel_directory": abspath(wheel_directory), "config_settings": config_settings, "metadata_directory": metadata_directory,},
        )
