...
def getPhases(debug):
        ...
        def wrapped(self, *args, **kwargs):
            if function.__name__.startswith("process") and len(args) > 0:
                ...
                self.parser.log.append(
                    (self.parser.tokenizer.state.__name__, self.parser.phase.__class__.__name__, self.__class__.__name__, function.__name__, info)
                )
        ...
        def __init__(self, parser, tree):
            ...
            self.startTagHandler = _utils.MethodDispatcher(
                [
                    ...
                    (("base", "basefont", "bgsound", "command", "link"), self.startTagBaseLinkCommand),
        ...
        def __init__(self, parser, tree):
            ...
            self.startTagHandler = _utils.MethodDispatcher(
                [
                    ...
                    (("base", "basefont", "bgsound", "link", "meta", "noframes", "script", "style", "title"), self.startTagFromHead),
                    ("head", self.startTagHead),
                ]
            )
            self.startTagHandler.default = self.startTagOther
    ...
    class InBodyPhase(Phase):
        ...
        def __init__(self, parser, tree):
            ...
            self.startTagHandler = _utils.MethodDispatcher(
                [
                    ("html", self.startTagHtml),
                    (("base", "basefont", "bgsound", "command", "link", "meta", "script", "style", "title"), self.startTagProcessInHead),
                    ("body", self.startTagBody),
                    ("frameset", self.startTagFrameset),
                    (
                        (
                    ...
                    (("caption", "col", "colgroup", "frame", "head", "tbody", "td", "tfoot", "th", "thead", "tr"), self.startTagMisplaced),
                ]
            )
            self.startTagHandler.default = self.startTagOther
            ...
            self.endTagHandler = _utils.MethodDispatcher(
                [
                    ...
                    (("a", "b", "big", "code", "em", "font", "i", "nobr", "s", "small", "strike", "strong", "tt", "u"), self.endTagFormatting),
        ...
        def __init__(self, parser, tree):
            ...
            self.endTagHandler = _utils.MethodDispatcher(
                [
                    ...
                    (("body", "caption", "col", "colgroup", "html", "tbody", "td", "tfoot", "th", "thead", "tr"), self.endTagIgnore),
                ]
            )
            self.endTagHandler.default = self.endTagOther
    ...
    class InCellPhase(Phase):
        ...
        def __init__(self, parser, tree):
            Phase.__init__(self, parser, tree)
            self.startTagHandler = _utils.MethodDispatcher(
                [("html", self.startTagHtml), (("caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr"), self.startTagTableOther)]
            )
            self.startTagHandler.default = self.startTagOther
    ...
    class InSelectPhase(Phase):
        def __init__(self, parser, tree):
            ...
            self.endTagHandler = _utils.MethodDispatcher(
                [("option", self.endTagOption), ("optgroup", self.endTagOptgroup), ("select", self.endTagSelect)]
            )
            self.endTagHandler.default = self.endTagOther
    ...
    class InFramesetPhase(Phase):
        ...
        def __init__(self, parser, tree):
            ...
            self.startTagHandler = _utils.MethodDispatcher(
                [("html", self.startTagHtml), ("frameset", self.startTagFrameset), ("frame", self.startTagFrame), ("noframes", self.startTagNoframes)]
            )
            self.startTagHandler.default = self.startTagOther
