        ...
        if self.is_repository_directory(dest):
            ...
            if self.compare_urls(existing_url, url):
                ...
                if not self.is_commit_id_equal(dest, rev_options.rev):
                    logger.info(
                        "Updating %s %s%s", display_path(dest), self.repo_name, rev_display,
                    )
    ...
    def run_command(
        ...
        try:
            ...
            if e.errno == errno.ENOENT:
                raise BadCommand("Cannot find command %r - do you have " "%r installed and in your " "PATH?" % (cls.name, cls.name))
            else:
