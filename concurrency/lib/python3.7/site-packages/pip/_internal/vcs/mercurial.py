...
class Mercurial(VersionControl):
    ...
    def get_remote_url(cls, location):
        url = cls.run_command(["showconfig", "paths.default"], show_stdout=False, cwd=location).strip()
    ...
    def get_revision_hash(cls, location):
        current_rev_hash = cls.run_command(["parents", "--template={node}"], show_stdout=False, cwd=location).strip()
