...
def parse_requirements(
    ...
    for line_number, line in lines_enum:
        req_iter = process_line(
            line, filename, line_number, finder, comes_from, options, session, wheel_cache, use_pep517=use_pep517, constraint=constraint
        )
        for req in req_iter:
            yield req
...
def process_line(
    ...
    if args_str:
        ...
        yield install_req_from_line(
            args_str, line_comes_from, constraint=constraint, use_pep517=use_pep517, isolated=isolated, options=req_options, wheel_cache=wheel_cache
        )
    ...
    # yield an editable requirement
        ...
        yield install_req_from_editable(
            opts.editables[0], comes_from=line_comes_from, use_pep517=use_pep517, constraint=constraint, isolated=isolated, wheel_cache=wheel_cache
        )
